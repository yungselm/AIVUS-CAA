...
class ContourBasedGating:
    ...
    def prepare_data(self):
        ...
        self.correlation = self.normalize_data(self.calculate_correlation())  # Pass frames as an argument to calculate_correlation()
    ...
    def get_x_indices():
        x_indices = [line.get_xdata()[0] for line in vertical_lines]
        return x_indices

    def plot_data(self):
        global vertical_lines, selected_line
