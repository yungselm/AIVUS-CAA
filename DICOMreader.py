...
def DICOMreader(path):
    ...
    ds = dcm.dcmread(r"D:\Documents\2_Coding\Python\AAOCASeg\AAOCASeg\rest.dcm")
...
def IVUS_gating_diastole(images, speed, frame_rate):
...
def IVUS_gating_systole(frame_rate, speed, tags_dia):
...
def stack_generator(images, tags_dia, tags_sys):
